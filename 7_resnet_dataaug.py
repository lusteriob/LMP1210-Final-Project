...
class CWT3DImageDataset(Dataset):
    def __init__(self, data_dir, patient_ids, target_size=(16, 96, 96), augment_healthy=False):
        ...
        self.augment_healthy = False  # Disable augmentation for version 7.2
...
def run_pretrained_resnet_training(data_dir):
    ...
    train_ds = CWT3DImageDataset(data_dir, train_ids, target_size=target_size, augment_healthy=False)
    ...
    if os.path.exists("resnet_18.pth"):
        print("\n>>> Loading pretrained MedicalNet weights...")
        pretrained_weights = torch.load("resnet_18.pth", map_location=device)
...
if __name__ == "__main__":
    ...
    run_pretrained_resnet_training(DATA_DIR)
